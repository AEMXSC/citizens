...
/**
 * Transformer: New York Life Dynamic Media / Scene7 images.
 *
 * The source site serves images from Adobe Scene7 IS/Image URLs, e.g.
 *   https://assets.newyorklife.com/is/image/newyorklife/<name>-w<W>-h<H>
 *   https://assets.newyorklife.com/is/image/nylAssetsProd/<name>-3x2-ratio-w<W>-h<H>
 * (detected in migration-work/metadata.json .images.mapping).
 *
 * Converts DM/Scene7 <img> tags into anchors so the URL round-trips through
 * markdown intact. On the client side, a companion auto-block in
 * scripts/scripts.js (buildDynamicMediaImages) rebuilds responsive <picture>
 * markup from those anchors, preserving all Scene7 template parameters.
 *
 ...
 * anchors earlier would leave parsers with no img to extract.
 *
 * Canonical helpers below are copied verbatim from
 * references/dm-scene7-helpers.js and must stay byte-identical.
 */
